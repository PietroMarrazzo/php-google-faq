...
<body>
    <header>
        <div class="navbar p-fixed z-1">
            <div class="logo-user-box d-flex">
                <span class="d-flex">
                    <img id="logoG" src="./img/logo.png" alt="">
                    <h2>Privacy e Termini</h2>
                </span>
                
                <ul class="user d-flex ul-nostyle">
                    <i class="fas fa-bars"></i>
                    <button>Accedi</button>    
                </ul>
            </div>
            <ul class="ul-nav d-flex ul-nostyle">
                <li>
                    <h4>Introduzione</h4>
                </li>
                <li>
    ...
    <main>
        <div class="container">
            ...
            <?php
                ...
                // var_dump($faqs);
            ?>
            <ul class="question-answer-list ul-nostyle">
                <?php foreach ($faqs as $key => $faq) { ?>
                        <li>
                            <!-- question -->
                            <h2 style="color: rgb(71, 71, 71)"> <?php echo $faq["question"] ?> </h2>
                            <!-- answer -->
